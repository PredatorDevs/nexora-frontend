...
También ofrece tema claro, oscuro o del sistema, densidad configurable y
preferencias de accesibilidad persistidas por navegador.
...
- [Accesibilidad, temas y preferencias](docs/accessibility-and-preferences.md)
...
- [Historial de cambios](docs/entity-change-history.md)
