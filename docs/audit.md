...
El historial de estados anterior/nuevo se consulta en una pantalla separada para
evitar mezclar eventos de seguridad con cambios persistidos. Consulta
[`entity-change-history.md`](entity-change-history.md).
